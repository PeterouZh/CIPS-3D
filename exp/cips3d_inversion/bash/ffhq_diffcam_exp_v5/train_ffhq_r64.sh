...
# bash = bash CIPS-3D/exp/cips3d_inversion/bash/ffhq_diffcam_exp_v5/train_ffhq_r64.sh 0 bucket-3690
...
python -c "from exp.tests.test_cips3d_inversion import Testing_ffhq_diffcam_exp_v5;\
  ...
  --tl_opts \
    ...
    G_cfg.nerf_cfg.shape_net_cfg.use_pos_enc False G_cfg.nerf_cfg.shape_net_cfg.grad_norm_layer False \
