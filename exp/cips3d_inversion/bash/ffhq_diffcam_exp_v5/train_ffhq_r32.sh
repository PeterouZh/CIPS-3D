...
# bash = bash CIPS-3D/exp/cips3d_inversion/bash/ffhq_diffcam_exp_v5/train_ffhq_r32.sh 0 bucket-3690
...
python -c "from exp.tests.test_cips3d_inversion import Testing_ffhq_diffcam_exp_v5;\
  ...
  --tl_opts \
    batch_size 4 img_size 32 total_iters 200000 \
    warmup_D False fade_steps 10000 \
    train_aux_img True G_kwargs.nerf_kwargs.N_samples 12 G_kwargs.nerf_kwargs.N_importance 12 \
    grad_points 32 \
    G_cfg.shape_block_end_index 8 G_cfg.app_block_end_index 1 G_cfg.inr_block_end_index 1 \
    G_cfg.nerf_cfg.shape_net_cfg.use_pos_enc False G_cfg.nerf_cfg.shape_net_cfg.grad_norm_layer True \
    G_cfg.nerf_cfg.shape_net_cfg.freq_scale 15. G_cfg.nerf_cfg.shape_net_cfg.freq_shift 30. \
