...
from exp.comm import comm_utils, comm_model_utils
...
@MODEL_REGISTRY.register(name_prefix=__name__)
class GeneratorNerfINR_xyz_d_posenc(GeneratorNerfINR):
  ...
  def __init__(self,
    ...
    # nerf_net
    self.siren = NeRFNetwork_xyz_d_posenc(**nerf_cfg)
...
@MODEL_REGISTRY.register(name_prefix=__name__)
class GeneratorNerfINR_xyz_posenc(GeneratorNerfINR):
  ...
  def __init__(self,
    ...
    # nerf_net
    self.siren = NeRFNetwork_xyz_posenc(**nerf_cfg)
...
class NeRFNetwork_xyz_d_sine(NeRFNetwork_xyz_d_posenc):
  ...
  def __init__(self,
    ...
    # Note that the first FiLMLayer already contains a FC + sine.
    self.xyz_emb = nn.Identity()
    dim_xyz_emb = 3
    # self.dir_emb = comm_model_utils.PosEmbedding(max_logscale=3, N_freqs=4)
    # dim_dir_emb = self.dir_emb.get_out_dim()
    dim_dir_emb = 27
    self.dir_emb = nn.Sequential(
      nn.Linear(3, dim_dir_emb),
      SinAct(),
    )
...
@MODEL_REGISTRY.register(name_prefix=__name__)
class GeneratorNerfINR_xyz_d_sine(GeneratorNerfINR):
  ...
  def __init__(self,
    ...
    # nerf_net
    self.siren = NeRFNetwork_xyz_d_sine(**nerf_cfg)
