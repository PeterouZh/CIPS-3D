...
class GeneratorNerfINR(GeneratorNerfINR_base):
  def __init__(self,
    ...
    # self.siren = nerf_network.NeRFNetwork_CLN(**nerf_cfg)
    self.siren = nerf_network.NeRFNetwork_Small(**nerf_cfg)
    ...
    self.mapping_network_aux = multi_head_mapping.MultiHeadMappingNetwork(
      **{**mapping_inr_cfg,
         'head_dim_dict': self.aux_to_rbg.style_dim_dict,
         })
  ...
  def mapping_network(self, z):
    ...
    style_dict.update(self.mapping_network_aux(z))
    return style_dict
