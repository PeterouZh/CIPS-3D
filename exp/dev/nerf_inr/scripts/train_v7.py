...
def train(rank,
    ...
    if global_cfg.tl_resume:
        ...
        torch_utils.load_models(save_dir=resume_dir, model_dict=model_dict, strict=True, rank=rank)
            ...
            if rank == 0:
                ...
                if global_cfg.tl_debug or \
                    ...
                    summary_dict = {
                        ...
                        'grad_points': grad_points if grad_points is not None else metadata['img_size'],
